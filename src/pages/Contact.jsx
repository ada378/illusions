        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 hover-shadow animate-fadeInLeft">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-xl font-semibold text-lg hover-scale hover-shadow transition-all duration-300 animate-fadeInUp"
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6 animate-fadeInUp">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">123 Innovation Street<br />Tech City, TC 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6 animate-fadeInUp" style={{animationDelay: '0.2s'}}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">hello@illusion.com</p>
                  </div>
                </div>
              </div>
            </div>
